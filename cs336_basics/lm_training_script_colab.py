...
parser.add_argument("--train_path", type=str, default = 'output/np_training_set.npy', help="Train Set Path")
parser.add_argument("--val_path", type=str, default = 'output/np_validation_set.npy', help="Val Set Path")
...
non_embedding_params = total_params- 10000*args.d_model*2
...
run = wandb.init(
    ...
    config={
        ...
        "non-embedding_params": non_embedding_params
    },
)
...
train_ids = np.load(args.train_path, mmap_mode='r')
val_ids = np.load(args.val_path, mmap_mode='r')
